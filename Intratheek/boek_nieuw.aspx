<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="boek_nieuw.aspx.vb" Inherits="Intratheek.boek_nieuw" %>
    ...
    <div id="container">
		...
		<h1>Boek toevoegen</h1>
            ...
            <asp:FileUpload ID="fuCover" runat="server" EnableTheming="True" />
                ...
                <asp:Label ID="lblCoverVal" runat="server" ForeColor="#990000" Text="* Geen cover geselecteerd" Visible="False"></asp:Label>
            ...
            <asp:TextBox ID="txtFlaptekst" runat="server" CssClass="search" Height="100px" TextMode="MultiLine" Width="359px" Font-Names="Verdana"></asp:TextBox>
                <br /><br />
                <center><asp:Button ID="btnAanmaken" runat="server" Text="Boek aanmaken" CssClass="lenenKnop" /></center>
            </div>
            </asp:Panel>
        </div>
		<div id="footer">
