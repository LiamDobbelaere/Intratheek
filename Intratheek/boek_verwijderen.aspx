<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="boek_verwijderen.aspx.vb" Inherits="Intratheek.boek_verwijderen" %>
...
<body>
    ...
    <div id="container">
		...
		<h1>Boek verwijderen</h1>
            ...
            <br /><br />
            <b>Let op!</b> U staat op het punt <asp:Literal ID="litBoekNaam" runat="server"></asp:Literal> te verwijderen. Dit wil zeggen dat alle exemplaren van dit boek <u>en het boek zelf</u> onherstelbaar zullen verdwijnen. Wilt u doorgaan?
            <br /><br />    
